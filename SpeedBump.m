...
%set parameters
m=500;
k=1000000; % < N/m > spring stiffness
c=2000; % < N.s/m > damping coefficient
d=.8; %length of obstacle
Y=.3; %height of obstacle
v=4;
...
x=z(:,1);
%ode45 returns z in 2 columns, z1 & z2  % x = z1
%animate and plot results
speedbump_sim(v,t',x');
 
 
%% speedbump computation
...
w=0.8;%width of speedbump
h=.3;%height of speed bump
